...
<div style="display: flex;">
  <img src="examples/portada_1.png" alt="Descripción de la imagen 1" style="width: 40%; margin-right: 10px;">
  <img src="examples/portada_2.png" alt="Descripción de la imagen 2" style="width: 40%;">
</div>
